...
displaycapabilities().backgroundcolor.set(1f,0,0,1f);
         ...
         */
        _myFontProducer = Bitmaps.getFontProducer("/Users/maf/Arbeiten/code/eclipse/Px1m0dBridge/data/fonts/Courier New.ttf");

        /* set size and quality of the font texture */
        _myFontProducer.setSize(50);
        _myFontProducer.setSmoothFactor(1);
