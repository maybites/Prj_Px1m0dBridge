...
public class NewInterpolateSinus implements InterpolatorKernel, Serializable {
    ...
    public NewInterpolateSinus(float theXOffset, float theYOffset, float theFrequency, float theAmplitude) {
