...
/**
  ...
  *
  */
public class PlgAutoPiper extends Plug {
	private static final long serialVersionUID = 1L;

	public PlgAutoPiper(Socket sm, PlugConfig param, Px1MessageSocket msg){
		super(sm, param, msg);
		...
		// onto its listeners
		GstrPipeConnctServerAuto pipeServer = new GstrPipeConnctServerAuto(this);
		// listens to button events
		plugging.registerListener(pipeServer);
		//********
		...
		BhavePipeConnctServerAuto piper = new BhavePipeConnctServerAuto(this, painter);
		// it listens to the pipe-connection-server for the conditions of the pipe connections
		pipeServer.registerListener(piper);
		// it listens to the pipe connection receiver pipe events:
		...
		// and it listens to metronome clicks
